...
internal class Exceptions
{
    public static T[] Subsequence<T>(T[] arr, int startIndex, int count)
    {
        ...
        {
            throw new ArgumentOutOfRangeException("Start index", "The start index should be in the range [0 ... arr.Length).");
        }

        if (count < 0 || count > arr.Length - startIndex)
        {
            throw new ArgumentOutOfRangeException("Count", "The count should be in the range [0 ... arr.Length - startIndex).");
        }
